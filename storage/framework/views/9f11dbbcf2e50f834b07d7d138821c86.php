...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('days', null, ['class' => 'form-control','required'=>'required', 'placeholder' => __('Enter Days / Year'),'min'=>'0'])); ?>
...
<?php /**PATH C:\laragon\www\donquick_hrms\resources\views/leavetype/create.blade.php ENDPATH**/ ?>