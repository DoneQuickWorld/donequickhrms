...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Allowance Option')): ?>
        <a href="#" data-url="<?php echo e(route('loanoption.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Loan Option')); ?>" data-bs-toggle="tooltip" title=""
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Loan Option')): ?>
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                    data-url="<?php echo e(URL::to('loanoption/' . $loanoption->id . '/edit')); ?>"
                                                    data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                                    data-title="<?php echo e(__('Edit Loan Option')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/loanoption/index.blade.php ENDPATH**/ ?>