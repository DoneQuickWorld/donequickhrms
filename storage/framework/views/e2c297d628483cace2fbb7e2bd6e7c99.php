            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="card">
                        ...
                        <?php echo e(Form::open(['route' => 'features.store', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('feature_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create Features')); ?>"
                    ...
                    <div class="card">
                        ...
                        <?php echo e(Form::open(['route' => 'feature_highlight_create', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('highlight_feature_heading', $settings['highlight_feature_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('highlight_feature_description', $settings['highlight_feature_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
                                        ...
                                        <div class="choose-files mt-4">
                                            <label for="highlight_feature_image">
                                                ...
                                                <input type="file" name="highlight_feature_image"
                                                    id="highlight_feature_image" class="form-control file"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('features_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create Features Block')); ?>"
                                        class="btn btn-sm btn-primary">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
                                                        ...
                                                        <span>
                                                            <div class="action-btn bg-primary ms-2">
                                                                <a href="#"
                                                                    ...
                                                                    data-ajax-popup="true"
                                                                    data-title="<?php echo e(__('Edit Features Block')); ?>" data-size="lg"
                                                                    data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"
                                                                    data-original-title="<?php echo e(__('Edit')); ?>">
                                                                    <i class="ti ti-pencil text-white"></i>
                                                                </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\Modules/LandingPage\Resources/views/landingpage/features/index.blade.php ENDPATH**/ ?>