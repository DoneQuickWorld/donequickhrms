    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('discover_description', $discover['discover_description'], ['class' => 'form-control summernote-simple', 'placeholder' => __('Enter Description'), 'id'=>'mytextarea'])); ?>
...
<?php /**PATH C:\laragon\www\donquick_hrms\Modules/LandingPage\Resources/views/landingpage/discover/edit.blade.php ENDPATH**/ ?>