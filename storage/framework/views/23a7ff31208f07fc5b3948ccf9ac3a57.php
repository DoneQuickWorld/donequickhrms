<?php echo e(Form::model(null, ['route' => ['custom_page.update', $key], 'method' => 'PUT'])); ?>
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('menubar_page_name', $page['menubar_page_name'], ['class' => 'form-control font-style', 'placeholder' => __('Enter Page Name'), 'required' => 'required'])); ?>
        ...
        <div class="form-group col-md-12 page_url d-none">
            ...
            <?php echo e(Form::text('page_url', $page['page_url'], ['class' => 'form-control font-style', 'placeholder' => __('Enter Page URL')])); ?>
        ...
        <div class="form-group col-md-12 page_content">
            ...
            <?php echo Form::textarea('menubar_page_contant', $page['menubar_page_contant'], [
        ...
        <div class="col-lg-2 col-xl-2 col-md-2">
            <div class="form-check form-switch ml-1">
                <input type="checkbox" class="form-check-input" id="cust-theme-bg" name="header"
                    <?php echo e($page['header'] == 'on' ? 'checked' : ''); ?> />
        ...
        <div class="col-lg-2 col-xl-2 col-md-2">
            <div class="form-check form-switch ml-1">
                <input type="checkbox" class="form-check-input" id="cust-darklayout"
                    name="footer"<?php echo e($page['footer'] == 'on' ? 'checked' : ''); ?> />
        ...
        <div class="col-lg-2 col-xl-2 col-md-2">
            <div class="form-check form-switch ml-1">
                <input type="checkbox" class="form-check-input" id="cust-darklayout"
                    name="login"<?php echo e($page['login'] == 'on' ? 'checked' : ''); ?> />
...
<?php /**PATH C:\laragon\www\donquick_hrms\Modules/LandingPage\Resources/views/landingpage/menubar/edit.blade.php ENDPATH**/ ?>