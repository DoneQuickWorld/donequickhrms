    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('amount', '', ['class' => 'form-control', 'required' => 'required', 'step' => '0.01', 'placeholder' => __('Enter Amount')])); ?>
...
</script><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/assets/create.blade.php ENDPATH**/ ?>