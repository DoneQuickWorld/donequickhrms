...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Goal Type')); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Goal Type')): ?>
        <a href="#" data-url="<?php echo e(route('goaltype.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Goal Type')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Goal Type')): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            data-url="<?php echo e(route('goaltype.edit', $goaltype->id)); ?>"
                                                            data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                                            data-title="<?php echo e(__('Edit Goal Type')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/goaltype/index.blade.php ENDPATH**/ ?>