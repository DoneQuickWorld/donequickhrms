    ...
    <div class="row align-items-center m-1">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Contract')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('contract.create')); ?>" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="<?php echo e(__('Create New Contract')); ?>" data-title="<?php echo e(__('Create New Contract')); ?>"
                                        ...
                                        <?php $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="Id">
                                                    ...
                                                    <a href="<?php echo e(route('contract.show', \Illuminate\Support\Facades\Crypt::encrypt($contract->id))); ?>"
                                                    ...
                                                    <span>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Contract')): ?>
                                                            ...
                                                            <div class="action-btn bg-primary ms-2">
                                                                <a href="#" data-size="lg"
                                                                    data-url="<?php echo e(route('contracts.copy', $contract->id)); ?>"
                                                        ...
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="<?php echo e(route('contract.show', \Illuminate\Support\Facades\Crypt::encrypt($contract->id))); ?>"
                                                                class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="<?php echo e(__('View Contract')); ?>"><i
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Contract')): ?>
                                                            <div class="action-btn bg-info ms-2">
                                                                <a href="#" data-size="lg"
                                                                    ...
                                                                    class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="<?php echo e(__('Edit Contract')); ?>"><i
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Contract')): ?>
                                                            <div class="action-btn bg-danger ms-2">
                                                                ...
                                                                <a href="#!"
                                                                    ...
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="<?php echo e(__('Delete Contract')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/contracts/index.blade.php ENDPATH**/ ?>