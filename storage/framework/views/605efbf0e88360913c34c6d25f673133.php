                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('joinus_heading', $settings['joinus_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <div class="action-btn bg-danger ms-2">
                                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['join_us.destroy', $value->id], 'id' => 'delete-form-' . $key]); ?>
                                                                ...
                                                                <a href="#"
                                                                    ...
                                                                    data-confirm-yes="document.getElementById('delete-form-<?php echo e($value->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\Modules/LandingPage\Resources/views/landingpage/joinus.blade.php ENDPATH**/ ?>