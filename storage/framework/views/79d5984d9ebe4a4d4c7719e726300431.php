...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-sm-12">
            <div class="row">
                <div class="col-xl-3">
                    <div class="card sticky-    " style="top:30px">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="logo-content mt-4">
                                            <img id="image"
                                                src="<?php echo e($logo . '/' . $settings['site_logo'] . '?' . time()); ?>"
                                                class="big-logo"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('custom_page.create')); ?>" data-ajax-popup="true"
                                        ...
                                        data-title="<?php echo e(__('Create Menu Bar')); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\Modules/LandingPage\Resources/views/landingpage/menubar/index.blade.php ENDPATH**/ ?>