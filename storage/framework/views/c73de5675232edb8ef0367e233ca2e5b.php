...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Deduction Option')): ?>
        <a href="#" data-url="<?php echo e(route('deductionoption.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Deduction Option')); ?>" data-bs-toggle="tooltip" title=""
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/deductionoption/index.blade.php ENDPATH**/ ?>