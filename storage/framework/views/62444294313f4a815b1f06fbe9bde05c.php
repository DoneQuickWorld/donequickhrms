                    ...
                    <?php if($chatgpt_enable): ?>
                        <div class="text-end pt-3">
                            <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true"
                                data-url="<?php echo e(route('generate', ['email template'])); ?>" data-bs-toggle="tooltip"
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" aria-labelledby="dropdownLanguage">
                                ...
                                <?php $__currentLoopData = App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('manage.email.language', [$emailTemplate->id, $code])); ?>"
                                        class="dropdown-item <?php echo e($currEmailTempLang->lang == $code ? 'text-primary' : ''); ?>">
                                ...
                                <div class="row text-xs">
                                    ...
                                    <?php elseif($emailTemplate->slug == 'new_employee'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Employee Email')); ?> : <span
                                                    class="pull-right text-primary">{employee_email}</span></p>
                                            <p class="col-4"><?php echo e(__('Employee Branch')); ?> : <span
                                                    class="pull-right text-primary">{employee_branch}</span></p>
                                            <p class="col-4"><?php echo e(__('Employee Department')); ?> : <span
                                                    class="pull-right text-primary">{employee_department}</span></p>
                                            <p class="col-4"><?php echo e(__('Employee Designation')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'new_payroll'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Salary Month')); ?> : <span
                                                    class="pull-right text-primary">{salary_month}</span></p>
                                            <p class="col-4"><?php echo e(__('URL')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'new_ticket'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('App Url')); ?> : <span
                                                    class="pull-right text-primary">{app_url}</span></p>
                                            <p class="col-4"><?php echo e(__('Ticket Title')); ?> : <span
                                                    class="pull-right text-primary">{ticket_title}</span></p>
                                            <p class="col-4"><?php echo e(__('Ticket Employee Name')); ?> : <span
                                                    class="pull-right text-primary">{ticket_name}</span></p>
                                            <p class="col-4"><?php echo e(__('Ticket Code')); ?> : <span
                                                    class="pull-right text-primary">{ticket_code}</span></p>
                                            <p class="col-4"><?php echo e(__('Ticket Description')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'employee_transfer'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Transfer Date')); ?> : <span
                                                    class="pull-right text-primary">{transfer_date}</span></p>
                                            <p class="col-4"><?php echo e(__('Transfer Department')); ?> : <span
                                                    class="pull-right text-primary">{transfer_department}</span></p>
                                            <p class="col-4"><?php echo e(__('Transfer Branch')); ?> : <span
                                                    class="pull-right text-primary">{transfer_branch}</span></p>
                                            <p class="col-4"><?php echo e(__('Transfer Desciption')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'employee_resignation'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Last Working Date')); ?> : <span
                                                    class="pull-right text-primary">{resignation_date}</span></p>
                                            <p class="col-4"><?php echo e(__('Resignation Date')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'employee_trip'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('App Url')); ?> : <span
                                                    class="pull-right text-primary">{app_url}</span></p>
                                            <p class="col-4"><?php echo e(__('Employee ')); ?> : <span
                                                    class="pull-right text-primary">{employee_trip_name}</span></p>
                                            <p class="col-4"><?php echo e(__('Purpose of Trip')); ?> : <span
                                            ...
                                            <p class="col-4"><?php echo e(__('End Date')); ?> : <span
                                                    class="pull-right text-primary">{end_date}</span></p>
                                            <p class="col-4"><?php echo e(__('Country')); ?> : <span
                                                    class="pull-right text-primary">{place_of_visit}</span></p>
                                            <p class="col-4"><?php echo e(__('Description')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'employee_promotion'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Promotion Title')); ?> : <span
                                                    class="pull-right text-primary">{promotion_title}</span></p>
                                            <p class="col-4"><?php echo e(__('Promotion Date')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'employee_warning'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Subject')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'employee_termination'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Notice Date')); ?> : <span
                                                    class="pull-right text-primary">{notice_date}</span></p>
                                            <p class="col-4"><?php echo e(__('Termination Date')); ?> : <span
                                                    class="pull-right text-primary">{termination_date}</span></p>
                                            <p class="col-4"><?php echo e(__('Termination Type')); ?> : <span
                                    ...
                                    <?php elseif($emailTemplate->slug == 'contract'): ?>
                                        <div class="row">
                                            ...
                                            <p class="col-4"><?php echo e(__('Contract Employee')); ?> : <span
                                                    class="pull-right text-primary">{contract_employee}</span></p>
                                            <p class="col-4"><?php echo e(__('Contract Start Date')); ?> : <span
                                                    class="pull-right text-primary">{contract_start_date}</span></p>
                                            <p class="col-4"><?php echo e(__('Contract End Date')); ?> : <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/email_templates/show.blade.php ENDPATH**/ ?>