        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo e(Form::textarea('testimonials_description', null, ['class' => 'form-control', 'placeholder' => __('Enter Description'), 'id'=>'mytextarea'])); ?>
...
<?php /**PATH C:\laragon\www\donquick_hrms\Modules/LandingPage\Resources/views/landingpage/testimonials/create.blade.php ENDPATH**/ ?>