    ...
    <table class="messenger-list-item m-li-divider" data-contact="<?php echo e(Auth::user()->id); ?>">
        <tr data-action="0">
            ...
            <td style="position: relative" width="100%">
                <p data-id="<?php echo e(Auth::user()->id); ?>" data-type="user" style="text-align: start">Saved Messages
                    <span>You</span>
                </p>
        ...
        <tr data-action="0">
            ...
            <td width="100%">
                <p data-id="<?php echo e($user->id); ?>" data-type="user" style="text-align: start">
                    ...
                    <span><?php echo e($lastMessage->created_at->diffForHumans()); ?></span>
                </p>
                <span style="justify-content: left; display:flex;">
                    ...
                    <?php if($lastMessage->attachment == null): ?>
                        <?php echo strlen($lastMessage->body) > 30 ? trim(substr($lastMessage->body, 0, 30)) . '..' : $lastMessage->body; ?>
    ...
    <table class="messenger-list-item" data-contact="<?php echo e($user->id); ?>">
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                <?php endif; ?>
                <?php if(!empty($user->avatar)): ?>
                    <div class="avatar av-m" style="background-image: url('<?php echo e($profile . '/' . $user->avatar); ?>');">
                    </div>
                <?php else: ?>
                    <div class="avatar av-m" style="background-image: url('<?php echo e($profile . '/avatar.png'); ?>');">
                    </div>
                <?php endif; ?>
            </td>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\donquick_hrms\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>