...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Ticket')): ?>
        <a href="#" data-url="<?php echo e(route('ticket.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Ticket')); ?>"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($ticket->status == 'open'): ?>
                                            <div class="status_badge text-capitalize badge bg-success p-2 px-3 rounded">
                                                <?php echo e(__('Open')); ?></div>
                                        <?php elseif($ticket->status == 'close'): ?>
                                            <div class="status_badge text-capitalize badge bg-danger p-2 px-3 rounded">
                                                <?php echo e(__('Close')); ?></div>
                                    ...
                                    <td>
                                        <p
                                            ...
                                            <?php echo e($ticket->description); ?></p>
                                    </td>
                                    <td class="Action">
                                        <span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/ticket/index.blade.php ENDPATH**/ ?>