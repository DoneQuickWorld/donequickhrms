...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => __('Enter Event Description'), 'rows' => '3'])); ?>
...
<?php /**PATH C:\laragon\www\donquick_hrms\resources\views/event/create.blade.php ENDPATH**/ ?>