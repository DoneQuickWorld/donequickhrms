...
<?php $__env->startSection('action-button'); ?>
    <div class="float-end">
        ...
        <a href="<?php echo e(route('payroll.report.export', [
            'month' => isset($_GET['month']) ? $_GET['month'] : date('Y-m'),
            'branch' => !empty($_GET['branch']) ? $_GET['branch'] : 0,
            'department' => !empty($_GET['department_id']) ? $_GET['department_id'] : 0,
        ])); ?>"
            class="btn btn-sm btn-primary float-end" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Export')); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('branch', $branch, isset($_GET['branch']) ? $_GET['branch'] : '', ['class' => 'form-control select branch_id'])); ?>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        ...
                        <h7 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalBasicSalary'])); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        ...
                        <h7 class="report-text mb-0">
                            <?php echo e(\Auth::user()->priceFormat($filterData['totalSaturationDeduction'])); ?></h7>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        <h6 class="report-text gray-text mb-0"><?php echo e(__('Total Other Payment')); ?> :</h6>
                        <h7 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalOtherPayment'])); ?>
                                ...
                                <?php $__currentLoopData = $payslips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payslip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt($payslip->employee_id))); ?>"
                                                ...
                                                <?php echo e(!empty($payslip->employees) ? \Auth::user()->employeeIdFormat($payslip->employees->employee_id) : ''); ?></a>
                                        </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/report/payroll.blade.php ENDPATH**/ ?>