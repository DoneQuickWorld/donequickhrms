...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4"><?php echo e(__('Zoom Mettings')); ?></h4>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <h5 class="  text-primary">
                                                    <a href="#" data-size="lg"
                                                        data-url="<?php echo e(route('zoom-meeting.show', $event->id)); ?>"
                                                        data-ajax-popup="true" data-title="<?php echo e($event->title); ?>"
                                                        class="text-primary"><?php echo e($event->title); ?></a>
                                                </h5>
                                                <div class="card-text small text-dark">
                                                    <?php echo e(date('d F Y, h:m A', strtotime($event->start_date))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/zoom_meeting/calendar.blade.php ENDPATH**/ ?>