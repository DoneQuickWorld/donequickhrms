...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__("Payment Type")); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('action-button'); ?>
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Payment Type')): ?>
        <a href="#" data-url="<?php echo e(route('paymenttype.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Payment Type')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Payment Type')): ?>
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                    data-url="<?php echo e(URL::to('paymenttype/' . $paymenttype->id . '/edit')); ?>"
                                                    data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                                    data-title="<?php echo e(__('Edit Payment Type')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\donquick_hrms\resources\views/paymenttype/index.blade.php ENDPATH**/ ?>